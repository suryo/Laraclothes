/*
 ...
 Source Schema         : db_clothesstore

 Target Server Type    : MySQL
 Target Server Version : 100422
 File Encoding         : 65001

 Date: 20/06/2023 20:20:59
*/
...
-- ----------------------------
-- Table structure for category_models
-- ----------------------------
...
CREATE TABLE `category_models`  (
  ...
  `deleted` enum('Y','N') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of category_models
-- ----------------------------
INSERT INTO `category_models` VALUES (1, 'Kemeja', '2023-06-04 23:35:38', '2023-06-04 23:35:39', NULL);
INSERT INTO `category_models` VALUES (2, 'Celana', '2023-06-04 23:35:54', '2023-06-04 23:35:54', NULL);
INSERT INTO `category_models` VALUES (3, 'Boxer', '2023-06-04 23:36:05', '2023-06-04 23:36:05', NULL);
INSERT INTO `category_models` VALUES (4, 'Kaos', NULL, NULL, NULL);

-- ----------------------------
-- Table structure for customers_models
-- ----------------------------
DROP TABLE IF EXISTS `customers_models`;
CREATE TABLE `customers_models`  (
  `id` int NOT NULL,
...
-- ----------------------------
-- Records of customers_models
-- ----------------------------
INSERT INTO `customers_models` VALUES (1, 'Ucup', 'ucupubang@gmail.com', 83727271, 'Adoh', '2023-06-04 23:36:30', '2023-06-04 23:36:30', NULL);
INSERT INTO `customers_models` VALUES (2, 'Zeus', 'gacor@gmail.com', 87883828, 'Maxwin', '2023-06-04 23:37:13', '2023-06-04 23:37:14', NULL);
...
-- ----------------------------
-- Table structure for order_items_models
-- ----------------------------
DROP TABLE IF EXISTS `order_items_models`;
CREATE TABLE `order_items_models`  (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  `deleted` enum('Y','N') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK__order_models`(`id_order` ASC) USING BTREE,
  INDEX `FK_order_items_models_products_models`(`id_product` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of order_items_models
-- ----------------------------
INSERT INTO `order_items_models` VALUES (1, 1, 1, 3, 2, 90000, '2023-06-04 23:38:37', '2023-06-04 23:38:37', NULL);

-- ----------------------------
-- Table structure for order_models
-- ----------------------------
...
CREATE TABLE `order_models`  (
  ...
  `payment_status` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `created_at` datetime NULL DEFAULT NULL,
  `updated_at` datetime NULL DEFAULT NULL,
  `deleted` enum('Y','N') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK__customers_models`(`id_customer` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of order_models
-- ----------------------------
INSERT INTO `order_models` VALUES (1, 1, '2023-06-04 23:37:37', 90000, 'Shipping', '2023-06-04 23:37:55', '2023-06-04 23:37:55', NULL);
...
-- ----------------------------
-- Table structure for products_models
-- ----------------------------
...
-- ----------------------------
-- Records of products_models
-- ----------------------------
INSERT INTO `products_models` VALUES (1, '1', 'Kemeja erigo', 'Erigo Kemeja 38C Short', 100000, 10, NULL, NULL, NULL);
INSERT INTO `products_models` VALUES (2, '2', 'Celana Erigo', 'Kabel Listrik Isi 4', 15000, 30, '2023-06-04 23:34:58', '2023-06-04 23:34:58', NULL);
INSERT INTO `products_models` VALUES (3, '3', 'Boxer RVCA', 'RVCA Short 03O', 45000, 23, '2023-06-04 23:35:22', '2023-06-04 23:35:22', NULL);
INSERT INTO `products_models` VALUES (4, '1', 'kemeja REI', NULL, NULL, NULL, NULL, NULL, NULL);

-- ----------------------------
-- Table structure for review_models
-- ----------------------------
...
CREATE TABLE `review_models`  (
  ...
  `rating` int NOT NULL,
  `comment` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `date` datetime NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `deleted` enum('Y','N') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK_review_models_customers_models`(`id_customer` ASC) USING BTREE,
  INDEX `FK_review_models_products_models`(`id_products` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of review_models
-- ----------------------------
INSERT INTO `review_models` VALUES (1, 1, 3, 10, 'Bablas Angine', '2023-06-04 23:40:00', '2023-06-04 23:40:01', '2023-06-04 23:40:02', NULL);
...
INSERT INTO `setting_menu` VALUES (2, 'Auth', NULL, '#', NULL, 1, 'ki-address-book', 'menu', 1, NULL, NULL, 'false', NULL, '2023-05-23 01:39:56');
INSERT INTO `setting_menu` VALUES (3, 'Users', NULL, 'users', NULL, 2, 'ki-address-book', 'menu', 1, NULL, NULL, 'false', NULL, '2023-05-22 09:56:14');
INSERT INTO `setting_menu` VALUES (4, 'Roles', NULL, 'roles', NULL, 2, 'ki-address-book', 'menu', 2, NULL, NULL, 'false', NULL, '2023-05-23 03:37:13');
INSERT INTO `setting_menu` VALUES (5, 'Customer', NULL, 'customers_models', NULL, 1, 'ki-address-book', 'menu', 2, NULL, NULL, 'false', NULL, '2023-05-23 01:39:56');
INSERT INTO `setting_menu` VALUES (6, 'category_models', NULL, 'category_models', NULL, 1, 'ki-address-book', 'menu', 1, NULL, NULL, 'false', NULL, '2023-05-23 03:37:13');
INSERT INTO `setting_menu` VALUES (7, 'products_models', NULL, 'products_models', NULL, 1, 'ki-address-book', 'menu', 2, NULL, NULL, 'false', NULL, '2023-05-23 03:37:13');
INSERT INTO `setting_menu` VALUES (8, 'order_models', NULL, 'order_models', NULL, 1, 'ki-address-book', 'menu', 2, NULL, NULL, 'true', NULL, '2023-05-23 02:26:30');
INSERT INTO `setting_menu` VALUES (9, 'TRANSAKSI', NULL, '#', NULL, 0, 'ki-address-book', 'label', 1, NULL, NULL, 'false', NULL, '2023-05-23 03:23:28');
INSERT INTO `setting_menu` VALUES (10, 'order_models', NULL, 'order_models', NULL, 9, 'ki-address-book', 'menu', 2, NULL, NULL, 'false', NULL, '2023-05-23 03:23:28');
INSERT INTO `setting_menu` VALUES (11, 'Pengembalian', NULL, 'pengembalian', NULL, 9, 'ki-address-book', 'menu', 3, NULL, NULL, 'true', NULL, '2023-05-23 03:23:28');
INSERT INTO `setting_menu` VALUES (12, 'Edit Stock', NULL, NULL, NULL, 12, 'ki-address-book', 'menu', NULL, NULL, NULL, 'false', NULL, NULL);
INSERT INTO `setting_menu` VALUES (13, 'Order History', NULL, NULL, NULL, 12, 'ki-address-book', 'menu', NULL, NULL, NULL, 'false', NULL, NULL);
INSERT INTO `setting_menu` VALUES (14, 'Discount Product', NULL, NULL, NULL, 12, 'ki-address-book', 'menu', NULL, NULL, NULL, 'false', NULL, NULL);
...
INSERT INTO `setting_route` VALUES (86, 'customers_models', 'web', 'resources', 'App\\Http\\Controllers\\Back\\Customers_models\\Customers_modelsController', '', '', 'false', NULL, NULL);
INSERT INTO `setting_route` VALUES (87, 'category_models', 'web', 'resources', 'App\\Http\\Controllers\\Back\\Category_models\\Category_modelsController', '', '', 'false', NULL, NULL);
INSERT INTO `setting_route` VALUES (88, 'products_models', 'web', 'resources', 'App\\Http\\Controllers\\Back\\Products_models\\Products_modelsController', '', '', 'false', NULL, NULL);
INSERT INTO `setting_route` VALUES (89, 'order_models', 'web', 'resources', 'App\\Http\\Controllers\\Back\\Order_models\\Order_modelsController', '', '', 'false', NULL, NULL);
